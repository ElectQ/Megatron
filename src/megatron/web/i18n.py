...
_ZH: dict[str, str] = {
    ...
    # Public frontend
    "Admin": "后台",
    "A public daily digest. Personal analysis stays private.": "公开的每日速递;个人化解读不对外。",
    ...
    # Hero + pipeline strip
    "Daily briefing": "每日简报",
    "Signal, curated daily.": "每日精选的信息流。",
    "An LLM reads the day across every source, ranks what matters, and publishes what can be shared.": "由大模型通读当天全部来源,分级筛出要点,并公开可披露的部分。",
    "How it works": "工作流程",
    "streams": "条推送流",
    "Read": "阅读",
    "LLM analysis": "LLM 分析",
    ...
    "public blog": "公开博客",
    "private": "个人私有",
    # Public GitHub board (post_github.html). The wording is careful: it always
    # speaks of "accounts" and counts, never of people — the page has no people.
    "What is getting starred today": "今天在收藏什么",
    "Redacted — who starred it is not shown": "已脱敏 · 不显示收藏者",
    "repos": "仓库",
    "converged": "多人收敛",
    "new repos": "新建仓库",
    "releases": "新版本",
    "new faces": "新晋雷达",
    "Today's focus": "今日聚焦",
    "most converged": "收敛度最高",
    "Converged": "多人收敛",
    "starred by two or more accounts the same day": "2 个及以上账号同日收藏",
    "accounts starred it the same day": "个账号同日收藏",
    "New activity": "新动向",
    "new repos · releases": "新建仓库 · 新版本",
    "New": "新建",
    "Release": "发版",
    "Other repos": "其余仓库",
    "one account each": "单个账号收藏",
    "New faces": "新晋雷达",
    "newly followed accounts": "新被关注的账号",
    "No annotation from the model this round.": "模型这轮没有给出注解。",
    "Nothing published for this day.": "这一天没有可公开的内容。",
    "Topics today": "今日主题",
    "How this page is made": "这页怎么来的",
    "Public GitHub activity — stars, forks, new repos, releases — aggregated by repo. Repos several accounts landed on the same day rank first. The model writes the one-liner.": "一批账号的 GitHub 公开动作(收藏、fork、新建、发版)按仓库聚合,同一天被多个账号收藏的排在前面。「是什么」由模型标注。",
    "The public version never shows who starred what.": "公开版不显示是谁收藏的。",
    "Stargazer identities, the timeline and the by-person view exist only in the private digest.": "收藏者身份、时间线、按人分组的视图只存在于私有日刊里。",
}
